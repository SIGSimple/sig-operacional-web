<div class="panel" ng-controller="CadastroDivisaoBaciaController">
	<div class="panel-body">
		<form id="form" class="form form-horizontal" role="form">
			<div class="form-group element-group">
				...
				<div class="col-lg-4">
					<input type="text" class="form-control" name="desc_diretoria" ng-model="objectModel.desc_diretoria">
				</div>
			</div>

			<div class="form-group element-group">
				<label class="control-label col-lg-2">Nome do Diretor</label>
				<div class="col-lg-4">
					<input type="text" class="form-control" name="nome_diretor" ng-model="objectModel.nome_diretor">
				</div>
			</div>
		</form>
	</div>
