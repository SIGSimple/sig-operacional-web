<div class="panel" ng-controller="CadastroProgramaController">
	<div class="panel-body">
		<form id="form" class="form form-horizontal" role="form">
			<div class="form-group element-group">
				...
				<div class="col-lg-4">
					<input type="text" class="form-control" name="desc_depto" ng-model="objectModel.desc_depto">
				</div>
			</div>

			<div class="form-group element-group">
				<label class="control-label col-lg-2">Sigla</label>
				<div class="col-lg-1">
					<input type="text" class="form-control" name="sigla" ng-model="objectModel.sigla">
				</div>
			</div>
		</form>
	</div>
	...
	<div class="panel-footer clearfix">
		<div class="pull-left">
			<div class="box-inline">
				<button type="button" class="btn btn-danger btn-labeled fa fa-trash-o" ng-show="(objectModel.cod_depto)" data-toggle="modal" data-target='#modalExcluir'>Excluir cadastro</button>
			</div>
		</div>
