	...
	<div class="demo-set-body bg-dark">
		...
		<div class="demo-set-content clearfix">
			<div class="col-xs-6 col-md-4">
				<h4 class="text-lg mar-btm">Animações</h4>
				<div id="demo-anim" class="mar-btm">
					<label class="form-checkbox form-icon active">
						<input type="checkbox" checked=""> Habilitar Animações
					</label>
				</div>
				<p>Efeitos de Transição</p>
				<select id="demo-ease">
					<option value="effect" selected>ease (Padrão)</option>
				...
				<hr class="bord-no">
				<br>
				<h4 class="text-lg mar-btm">Menu de Navegação</h4>
				<div class="mar-btm">
				...
				<label id="demo-nav-coll" class="form-checkbox form-icon">
					<input type="checkbox"> Escondido
				</label>
				<hr class="bord-no">
				<br>
				<h4 class="text-lg mar-btm">Efeito Menu de Navegação</h4>
				<select id="demo-nav-offcanvas">
					<option value="none" selected disabled="disabled">-- Selecione --</option>
			...
			<div class="col-xs-12 col-md-5">
				<div id="demo-theme">
					<h4 class="text-lg mar-btm">Tema/Cores</h4>
		...
		<div class="pad-all text-left">
			<hr class="hr-sm">
			<p class="demo-set-save-text">* Todas as configurações são salvas automaticamente.</p>
			<button id="demo-reset-settings" class="btn btn-primary btn-labeled fa fa-refresh mar-btm">Restaurar configurações padrão</button>
		</div>
	</div>
