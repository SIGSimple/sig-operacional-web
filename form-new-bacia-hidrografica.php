<div class="panel" ng-controller="CadastroBaciaHidrograficaController">
	<div class="panel-body">
		<form id="form" class="form form-horizontal" role="form">
			<div class="form-group element-group">
				...
				<div class="col-lg-4">
					<input type="text" class="form-control" name="nme_bacia_hidrografica" ng-model="objectModel.nme_bacia_hidrografica">
				</div>
			</div>
		</form>
	</div>
